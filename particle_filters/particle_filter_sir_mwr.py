from SLLT.particle_filters.particle_filter_sir import ParticleFilterSIR, open_pf
...
class ParticleFilterMWR(ParticleFilterSIR):
    ...
    def __init__(self,
        ...
        ParticleFilterSIR.__init__(self, number_of_particles, evolution_matrix, process_noise_vector, parameters, 
                                   period, resampling_algorithm, confidence_level)
