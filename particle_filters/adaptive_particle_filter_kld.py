# set home directory to be 'dynamic_GEV' to avoid any confusion to find modules
if __name__ == "__main__":
    import os
    os.chdir(os.path.dirname(os.getcwd()))
    
# load required packages
from particle_filters.particle_filter_base import ParticleFilter
from particle_filters.resampling import generate_sample_index, compute_required_number_of_particles_kld
import numpy as np
