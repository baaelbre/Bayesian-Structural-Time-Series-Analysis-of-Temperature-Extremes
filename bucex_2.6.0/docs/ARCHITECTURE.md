...
Version 2.6.0 keeps one model compiler, one fitting entry point, and one result
...
length, and figure contract. `WorkflowPaths` maps each scenario, series,
...
Schema 2.6.0 archives contain allowlisted JSON metadata plus compressed NumPy
