...
class DLMGibbsConjugate:
    ...
    def save_posterior(self, out_npz_path: str, extra_meta: Optional[dict] = None) -> None:
        ...
        os.makedirs(os.path.dirname(out_npz_path), exist_ok=True) # ensure dir exists
...
if __name__ == "__main__":
    ...
    p.add_argument("--q-level", type=float, default=0.)
    ...
    p.add_argument("--prior-a-P0-beta",  type=float, default=1.0)
