...
class DLMGibbsHarmonic:
    """
    Gaussian structural DLM with harmonic seasonal states, **disturbance non-centred** version.
    ...
    # (unchanged except they now use self.x that was rebuilt from (x0, eta, s))
