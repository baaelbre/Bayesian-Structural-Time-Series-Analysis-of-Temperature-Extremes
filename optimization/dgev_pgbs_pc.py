...
class DGEVParticleGibbs:
    ...
    def run(self) -> Dict[str, np.ndarray]:
        ...
        for it in range(cfg.n_iter):
            ...
            if self.dim > 0:
                if cfg.progress: print("  Updating Q (PC priors)...")
                self.update_Q()
                if ema_Q is not None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pc-u-alpha", type=float, default=1e-2)
    parser.add_argument("--pc-alpha-alpha", type=float, default=0.1)
    parser.add_argument("--pc-lambda-alpha", type=float, default=float("nan"))

    parser.add_argument("--pc-u-beta", type=float, default=1e-4)
    parser.add_argument("--pc-alpha-beta", type=float, default=0.1)
