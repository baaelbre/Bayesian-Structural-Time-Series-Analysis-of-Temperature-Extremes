...
Factor models support centered and disturbance strategies. The specialized FS
layout is not generalized to factor graphs; requesting it fails before
sampling.

## Persistence

`.bucex` v2 archives contain JSON metadata and compressed NumPy arrays. Loading
...
The v2 loader also accepts safe v1.2 archives.
