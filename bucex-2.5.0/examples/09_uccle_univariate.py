...
The default SSVS run asks, for each summary separately, whether the level is
fixed/dynamic, the slope is zero/fixed/dynamic, and seasonality is
fixed/dynamic.
...
def prior_for(series: str):
    ...
    if PRIOR != "ssvs":
        return PRIOR
    return bx.componentwise_univariate_prior(series)
