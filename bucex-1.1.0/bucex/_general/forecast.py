...
from .numerics import sample_mvn
from .scores import evaluate_ensemble
...
def posterior_predict(
    ...
    *,
    ...
    parameter_values = {name: fit.parameter(name)[indices] for name in fit.parameter_draws if not name.startswith("slab.")}
