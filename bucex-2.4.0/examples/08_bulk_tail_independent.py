...
but it does not create a joint likelihood or share priors. Use Example 7 when
the bulk and tail should learn common structural probabilities or slab scales.
"""
