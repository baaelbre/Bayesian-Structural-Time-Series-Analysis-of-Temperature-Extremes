#!/usr/bin/env python3
"""Fixed-seed numerical release validation for bucex 2.6.1."""
...
def run() -> dict[str, object]:
    ...
    if bx.__version__ != "2.6.1":
        raise RuntimeError(f"Expected bucex 2.6.1, found {bx.__version__}.")
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("validation/release_validation_2.6.1.json"),
    )
