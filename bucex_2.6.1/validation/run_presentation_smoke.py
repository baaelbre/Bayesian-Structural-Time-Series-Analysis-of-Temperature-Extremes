#!/usr/bin/env python3
"""End-to-end software smoke test for the v2.6.1 presentation workflow."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("validation/presentation_smoke_2.6.1.json"),
    )
    args = parser.parse_args()
    if args.work_dir is None:
        with tempfile.TemporaryDirectory(prefix="bucex-2.6.1-") as directory:
