...
# When this file is executed by path, Python otherwise searches this directory
# before the adjacent source checkout and may find an older installed release.
