"""Configuration and deterministic artifact paths for the 2.6.1 presentation."""
...
class RuntimeSettings:
    ...
    def __post_init__(self) -> None:
        ...
        if self.simulation_period < 2:
            raise ValueError("simulation_period must be at least two.")


PROFILE_SETTINGS: dict[str, RuntimeSettings] = {
    "smoke": RuntimeSettings(2, 2, 1, 24, 48, 4),
    "pilot": RuntimeSettings(250, 250, 2, 128, 400, 4),
    "publication": RuntimeSettings(2_000, 2_000, 4, 512, 800, 4),
}
...
class PresentationConfig:
    ...
    def for_profile(
        ...
        *,
        ...
        simulation_period: int | None = None,
        figure_formats: tuple[str, ...] = ("pdf", "png"),
        figure_dpi: int = 180,
    ) -> "PresentationConfig":
