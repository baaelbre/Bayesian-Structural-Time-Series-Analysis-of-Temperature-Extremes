...
| Observation | Engine | State update | Posterior target |
| --- | --- | --- | --- |
...
`engine="auto"` selects FFBS for Gaussian and Laplace for GEV. PGAS handles
singular structural transitions on their affine support and reports ESS,
ancestor diversity and path-change diagnostics.
...
| `disturbance` | Any compiled model | Standardized/scaled disturbances | `centered` |
