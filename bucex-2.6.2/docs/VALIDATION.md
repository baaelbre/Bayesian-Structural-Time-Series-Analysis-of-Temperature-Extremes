...
Version 2.6.2 has five software layers:
...
- the seven PBS jobs invoke those same examples and PGAS dependencies pass
  through the corresponding completed Laplace job;
